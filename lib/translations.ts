...
const translations = {
  ...
  // ─── Comparison Section ───
  "comp.title": { en: "Why Saju Is Different", ko: "사주가 다른 이유", ja: "四柱推命が異なる理由" },
  ...
  "pc.consult.desc": { en: "5 AI-powered Saju sessions", ko: "5회 AI 사주 세션", ja: "5回のAI四柱セッション" },
  "pc.consult.cta": { en: "Get 5 AI Sessions", ko: "AI 세션 5회 구매", ja: "AIセッション5回を購入" },
  "pc.consult.perSession": { en: "$6 per session", ko: "1회당 $6", ja: "1回あたり$6" },
  "pc.consult.f1": { en: "5 AI-generated sessions, powered by RimSaju Engine", ko: "5회 AI 생성 세션 — RimSaju 엔진 기반", ja: "5回のAI生成セッション — RimSajuエンジン搭載" },
  ...
  "pc.consult.f4": { en: "Follow-up analysis rounds for deeper precision", ko: "심층 분석을 위한 후속 분석 라운드", ja: "より深い精度のための追加分析ラウンド" },
  "pc.consult.f5": { en: "Comprehensive AI analysis report per session", ko: "세션당 종합 AI 분석 보고서", ja: "セッションごとの包括的AI分析レポート" },
  "pc.consult.f6": { en: "All sessions saved to your dashboard", ko: "모든 세션 대시보드에 저장", ja: "すべてのセッションをダッシュボードに保存" },
  ...
  "faq.a6": { en: "Yes! Your purchase is linked to your account and accessible on the web and the app where you used the same sign-in method. In the iOS app, use Apple sign-in; in the Android app, use Google sign-in. Prices are the same across all platforms — web or mobile app. Prices are the same across all platforms ($9.99 / $29.99).", ko: "네! 구매 내역은 계정(Google 또는 Apple)에 연결되어 웹과 앱 모든 기기에서 이용 가능합니다. 모든 플랫폼에서 동일 가격($9.99 / $29.99).", ja: "はい！購入はアカウント（GoogleまたはApple）に紐付けられ、ウェブ・アプリどのデバイスでも利用可能です。全プラットフォーム同一価格（$9.99 / $29.99）。" },
  "faq.q7": { en: "Do I need to sign in to pay?", ko: "결제하려면 로그인해야 하나요?", ja: "支払いにはログインが必要ですか？" },
  "faq.a7": { en: "Yes. We require sign-in before any purchase so your paid content is permanently saved to your account and accessible from your dashboard on any device. Sign-in is free and takes one click.", ko: "네. 구매 전 로그인(Google 또는 Apple) 필요. 유료 콘텐츠가 계정에 영구 저장. 로그인은 무료이며 클릭 한 번.", ja: "はい。購入前にログイン（GoogleまたはApple）が必要。有料コンテンツがアカウントに永久保存。ログインは無料でワンクリック。" },
  ...
  "faq.a10": { en: "A focused AI analysis round from our RimSaju Engine. Enter your birth details directly (no prior reading needed), submit a life question — career, love, timing, wealth, health — and receive a comprehensive analysis grounded in your birth chart and 562 classical passages, with concrete timing guidance and actionable insights. 5 rounds for $29.99. If you already have a reading, your birth data is auto-filled.", ko: "RimSaju 엔진 기반 AI 집중 분석 라운드. 생년월일 직접 입력(사전 리딩 불필요), 질문 제출 후 사주 차트와 562개 고전 구절을 기반으로 한 종합 분석을 받습니다. 5회 $29.99. 기존 리딩이 있으면 자동 입력.", ja: "RimSajuエンジンによるAI集中分析ラウンド。生年月日を直接入力（事前鑑定不要）、質問を送ると四柱と562の古典パッセージに基づく包括的分析が届きます。5回$29.99。既存鑑定がある場合は自動入力。" },
  ...
  "faq.a14": { en: "Yes. Your data is stored securely and never shared with third parties. We use industry-standard encryption and security. Delete your account from your dashboard, or contact us anytime.", ko: "네. 안전하게 저장, 제3자 미공유. 업계 표준 암호화. 언제든 삭제 요청 가능.", ja: "はい。安全に保存、第三者と共有しません。いつでも削除リクエスト可能。" },

  // ─── Consultation ───
  "consult.badge": { en: "Master Consultation", ko: "마스터 상담", ja: "マスター相談" },
  "consult.title1": { en: "Your Personal", ko: "나만의", ja: "あなただけの" },
  "consult.title2": { en: "AI Saju Session", ko: "AI 사주 세션", ja: "AI四柱セッション" },
  "consult.desc": { en: "Ask any life question and receive a detailed AI analysis from our RimSaju Engine, grounded in your unique birth chart and 562 classical passages.", ko: "삶의 어떤 질문이든 하세요. RimSaju 엔진의 AI 분석이 당신의 사주와 562개 고전 구절을 기반으로 상세한 답변을 제공합니다.", ja: "人生のあらゆる質問をどうぞ。RimSajuエンジンのAI分析が、あなたの四柱と562の古典パッセージに基づいて詳細な答えをお届けします。" },
  ...
  "consult.personalTitle": { en: "AI Saju Consultations", ko: "AI 사주 상담", ja: "AI四柱相談" },
  "consult.personalDesc": { en: "Get in-depth AI answers to your life questions — career, love, timing, and more — computed from your unique birth chart by the RimSaju Engine.", ko: "삶의 질문에 대한 AI 심층 답변 — 직업, 연애, 시기 등 — RimSaju 엔진이 당신의 사주를 기반으로 계산.", ja: "人生の質問への深いAIの答え — 仕事、恋愛、タイミングなど — RimSajuエンジンがあなたの四柱から計算します。" },
  "consult.priceTag": { en: "5 AI analysis rounds for $29.99 · No subscription", ko: "5회 AI 분석 $29.99 · 구독 없음", ja: "5回AI分析 $29.99 · サブスクなし" },
  "consult.unlockDesc": { en: "Get 5 in-depth AI Saju analysis rounds for any life question — career, love, timing, and more. Each round produces a comprehensive analysis computed from your birth chart by the RimSaju Engine.", ko: "모든 질문에 대한 5회 심층 AI 사주 분석 라운드. RimSaju 엔진이 라운드당 종합 분석을 사주 기반으로 생성합니다.", ja: "あらゆる質問に5回の深いAI四柱分析ラウンド。RimSajuエンジンがラウンドごとに包括的分析をあなたの四柱から生成します。" },
  "consult.perSession": { en: "$6 per analysis round · No subscription", ko: "1회 $6 · 구독 없음", ja: "1回$6 · サブスクなし" },
  "consult.feat1": { en: "5 AI-generated sessions, powered by RimSaju Engine", ko: "5회 AI 생성 세션 — RimSaju 엔진 기반", ja: "5回のAI生成セッション — RimSajuエンジン搭載" },
  ...
  "signIn.continueApple": { en: "Continue with Apple", ko: "Apple로 계속하기", ja: "Appleで続ける" },
  ...
  "wis.hook.saju": { en: "Saju: 518,400 Unique Profiles", ko: "사주: 518,400가지 고유 프로필", ja: "四柱推命：518,400通りのプロフィール" },

  // How Saju Works
  "wis.how.title": { en: "How Saju Works", ko: "사주의 원리", ja: "四柱推命の仕組み" },
  ...
  "wis.how.s2.desc": { en: "Everything in Saju maps to five cosmic forces: Wood, Fire, Earth, Metal, and Water. Their balance in your chart determines your personality, strengths, and life path.", ko: "사주의 모든 것은 목, 화, 토, 금, 수 다섯 가지 우주적 힘으로 연결됩니다. 이들의 균형이 성격, 강점, 인생 방향을 결정합니다.", ja: "四柱推命のすべては木・火・土・金・水の五つの力に紐付きます。そのバランスが性格・強み・人生の方向性を決定します。" },
  ...
  "wis.diff.1.desc": { en: "Zodiac uses your birth month. Saju uses your exact birth hour and True Solar Time — calculated from your birth city's longitude.", ko: "별자리는 출생 월을 사용합니다. 사주는 정확한 출생 시각과 출생지 경도로 계산한 진태양시를 사용합니다.", ja: "星座は生まれた月を使う。四柱推命は正確な出生時刻と出生地の経度から計算した真太陽時を使います。" },
  "wis.diff.2.title": { en: "Depth", ko: "깊이", ja: "深さ" },
  "wis.diff.2.desc": { en: "MBTI gives you 16 types. Saju gives you 518,400+ unique combinations, each with distinct life patterns.", ko: "MBTI는 16가지 유형을 제공합니다. 사주는 각기 다른 인생 패턴을 가진 518,400가지 이상의 고유한 조합을 제공합니다.", ja: "MBTIは16タイプ。四柱推命は518,400通り以上の固有の組み合わせ、それぞれ異なる人生パターンを提供します。" },
