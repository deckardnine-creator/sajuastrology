...
const translations = {
  ...
  "faq.a12": { en: "On the web: PayPal, Visa, Mastercard, Amex, and other major cards via PayPal Checkout. In the app: Apple Pay (iOS) and Google Pay (Android) via in-app purchase. All transactions are encrypted and your payment details are never stored on our servers.", ko: "웹: PayPal, Visa, Mastercard, Amex 등 주요 카드. 앱: Apple Pay(iOS), Google Pay(Android) 인앱결제. 거래 암호화, 결제 정보 미저장.", ja: "ウェブ：PayPal、Visa、Mastercard、Amex等。アプリ：Apple Pay（iOS）、Google Pay（Android）のアプリ内課金。すべて暗号化、決済情報はサーバーに保存しません。" },
