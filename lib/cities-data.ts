...
const CITY_ALIASES: Record<string, string[]> = {
  ...
  "Seoul":     ["서울", "首爾", "ソウル", "そうる"],
  "Busan":     ["부산", "釜山", "プサン", "ぷさん"],
  "Incheon":   ["인천", "仁川", "インチョン", "いんちょん"],
  "Daegu":     ["대구", "大邱", "テグ", "てぐ"],
  "Daejeon":   ["대전", "大田", "テジョン", "てじょん"],
  "Gwangju":   ["광주", "光州", "クァンジュ", "くぁんじゅ"],
  "Suwon":     ["수원", "水原", "スウォン", "すうぉん"],
  "Ulsan":     ["울산", "蔚山", "ウルサン", "うるさん"],
  "Changwon":  ["창원", "昌原", "チャンウォン", "ちゃんうぉん"],
  "Goyang":    ["고양", "高陽", "コヤン", "こやん"],
  "Seongnam":  ["성남", "城南", "ソンナム", "そんなむ"],
  "Cheongju":  ["청주", "清州", "チョンジュ", "ちょんじゅ"],
  "Jeonju":    ["전주", "全州", "チョンジュ", "ちょんじゅ"],
  "Jeju":      ["제주", "濟州", "チェジュ", "ちぇじゅ"],
  "Pohang":    ["포항", "浦項", "ポハン", "ぽはん"],
  "Yongin":    ["용인", "龍仁", "ヨンイン", "よんいん"],
  ...
  "New York":       ["뉴욕", "紐約", "ニューヨーク", "にゅーよーく"],
  "Los Angeles":    ["로스앤젤레스", "洛杉磯", "LA", "엘에이", "ロサンゼルス", "ろさんぜるす"],
  "Chicago":        ["시카고", "芝加哥", "シカゴ", "しかご"],
  "Houston":        ["휴스턴", "休士頓", "ヒューストン", "ひゅーすとん"],
  "San Francisco":  ["샌프란시스코", "舊金山", "サンフランシスコ", "さんふらんしすこ"],
  "Seattle":        ["시애틀", "西雅圖", "シアトル", "しあとる"],
  "Boston":         ["보스턴", "波士頓", "ボストン", "ぼすとん"],
  "Miami":          ["마이애미", "邁阿密", "マイアミ", "まいあみ"],
  "Washington DC":  ["워싱턴", "華盛頓", "ワシントン", "わしんとん"],
  "Atlanta":        ["애틀랜타", "亞特蘭大", "アトランタ", "あとらんた"],
  "Dallas":         ["달라스", "達拉斯", "ダラス", "だらす"],
  "Denver":         ["덴버", "丹佛", "デンバー", "でんばー"],
  "San Diego":      ["샌디에이고", "聖地牙哥", "サンディエゴ", "さんでぃえご"],
  "Portland":       ["포틀랜드", "波特蘭", "ポートランド", "ぽーとらんど"],
  "Las Vegas":      ["라스베이거스", "拉斯維加斯", "ラスベガス", "らすべがす"],
  "Honolulu":       ["호놀룰루", "檀香山", "ホノルル", "ほのるる"],
  "Philadelphia":   ["필라델피아", "費城", "フィラデルフィア", "ふぃらでるふぃあ"],
  "Austin":         ["오스틴", "奧斯汀", "オースティン", "おーすてぃん"],
  "London":         ["런던", "ロンドン"],
  "Paris":          ["파리", "パリ"],
  "Berlin":         ["베를린", "ベルリン"],
  "Rome":           ["로마", "ローマ"],
  ...
  "Sao Paulo":      ["상파울루", "聖保羅", "サンパウロ", "São Paulo"],
