    ...
    <main className="min-h-screen">
      ...
      <div className="pt-page pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
          ...
          <dd dangerouslySetInnerHTML={{ __html: `+82-10-4648-6793<br /><span className="text-muted-foreground text-xs">\u55b6\u696d\u6642\u9593\uff1a\u5e73\u65e510:00\u201318:00 KST\uff08\u571f\u65e5\u795d\u4f11\uff09</span><br /><span className="text-muted-foreground text-xs">\u203b \u97d3\u56fd\u3092\u62e0\u70b9\u3068\u3059\u308b\u4e8b\u696d\u8005\u3067\u3042\u308b\u305f\u3081\u3001\u304a\u554f\u3044\u5408\u308f\u305b\u306f\u4e0b\u8a18\u30e1\u30fc\u30eb\u30a2\u30c9\u30ec\u30b9\u5b9b\u3067\u627f\u3063\u3066\u304a\u308a\u307e\u3059\u3002</span>` }} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
          <dt className="font-semibold text-primary">\u30e1\u30fc\u30eb\u30a2\u30c9\u30ec\u30b9</dt>
          <dd dangerouslySetInnerHTML={{ __html: `<a href="mailto:info@rimfactory.io" className="text-primary hover:underline">info@rimfactory.io</a>` }} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
          ...
          <dd dangerouslySetInnerHTML={{ __html: `<a href="https://sajuastrology.com" className="text-primary hover:underline">https://sajuastrology.com</a>` }} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
          ...
          <dd dangerouslySetInnerHTML={{ __html: `\u5404\u5546\u54c1\u306e\u4fa1\u683c\u306f\u8cfc\u5165\u753b\u9762\u306b\u7c73\u30c9\u30eb\u5efa\u3066\u306b\u3066\u660e\u793a\u3057\u3066\u304a\u308a\u307e\u3059\u3002<br />\u30fbCompatibility Full\uff1aUS$2.99\uff08\u8cb7\u3044\u5207\u308a\uff09<br />\u30fbFull Destiny Reading\uff1aUS$9.99\uff08\u8cb7\u3044\u5207\u308a\uff09<br />\u30fbMaster 5 Pack\uff1aUS$29.99\uff08\u8cb7\u3044\u5207\u308a\u3001Full Destiny Reading \u3092\u542b\u3080\uff09<br />\u30fbSoram Companion\uff1aUS$4.99\uff0f\u6708\uff08\u81ea\u52d5\u66f4\u65b0\u30b5\u30d6\u30b9\u30af\u30ea\u30d7\u30b7\u30e7\u30f3\uff09<br /><span className="text-muted-foreground text-xs">\u203b \u70ba\u66ff\u30ec\u30fc\u30c8\u304a\u3088\u3073\u6c7a\u6e08\u4e8b\u696d\u8005\u306e\u63db\u7b97\u30ec\u30fc\u30c8\u306b\u3088\u308a\u3001\u5186\u5efa\u3066\u3067\u306e\u6700\u7d42\u6c7a\u6e08\u984d\u306f\u5909\u52d5\u3057\u307e\u3059\u3002</span>` }} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
          ...
          <dd dangerouslySetInnerHTML={{ __html: `\u672c\u30b5\u30fc\u30d3\u30b9\u306f\u30c7\u30b8\u30bf\u30eb\u30b3\u30f3\u30c6\u30f3\u30c4\u306e\u6027\u8cea\u4e0a\u3001\u6c7a\u6e08\u5b8c\u4e86\u3092\u3082\u3063\u3066\u5f79\u52d9\u306e\u63d0\u4f9b\u304c\u958b\u59cb\u3055\u308c\u308b\u305f\u3081\u3001\u304a\u5ba2\u69d8\u306e\u3054\u90fd\u5408\u306b\u3088\u308b\u8fd4\u54c1\u30fb\u8fd4\u91d1\u306f\u539f\u5247\u3068\u3057\u3066\u304a\u53d7\u3051\u3067\u304d\u307e\u305b\u3093\u3002<br />\u305f\u3060\u3057\u3001\u6280\u8853\u7684\u306a\u969c\u5bb3\u306b\u3088\u308a\u5546\u54c1\uff08\u9451\u5b9a\u66f8\uff09\u304c\u6b63\u5e38\u306b\u63d0\u4f9b\u3055\u308c\u306a\u304b\u3063\u305f\u5834\u5408\u306b\u9650\u308a\u3001\u8cfc\u5165\u65e5\u304b\u30897\u65e5\u4ee5\u5185\u306b\u4e0b\u8a18\u30e1\u30fc\u30eb\u30a2\u30c9\u30ec\u30b9\u307e\u3067\u3054\u9023\u7d61\u3092\u3044\u305f\u3060\u3051\u308c\u3070\u3001\u3054\u8fd4\u91d1\u3044\u305f\u3057\u307e\u3059\u3002<br /><span className="text-muted-foreground text-xs">\u203b Apple App Store \u304a\u3088\u3073 Google Play \u306e\u30a2\u30d7\u30ea\u5185\u8ab2\u91d1\u306b\u3064\u3044\u3066\u306f\u3001\u5404\u30b9\u30c8\u30a2\u306e\u8fd4\u91d1\u30dd\u30ea\u30b7\u30fc\u306b\u5f93\u3044\u3001\u5404\u30b9\u30c8\u30a2\u5b9b\u3066\u306b\u76f4\u63a5\u304a\u7533\u3057\u8fbc\u307f\u304f\u3060\u3055\u3044\u3002\u5f53\u793e\u304b\u3089\u8fd4\u91d1\u51e6\u7406\u3092\u304a\u3053\u306a\u3046\u3053\u3068\u306f\u3067\u304d\u307e\u305b\u3093\u3002</span>` }} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-1 md:gap-6 py-4 border-b border-border">
          ...
          <dd dangerouslySetInnerHTML={{ __html: `\u8a73\u7d30\u306f <a href="/terms" className="text-primary hover:underline">Terms of Service</a> \u304a\u3088\u3073 <a href="/privacy" className="text-primary hover:underline">Privacy Policy</a> \u3092\u3054\u53c2\u7167\u304f\u3060\u3055\u3044\u3002` }} />
        </div>
          </dl>
