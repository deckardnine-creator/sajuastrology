    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-24 md:bottom-6 right-4 md:right-6 z-10 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95"
          style={{
