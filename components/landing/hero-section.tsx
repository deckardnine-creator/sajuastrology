  ...
  return (
    <section className="relative min-h-screen pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center min-h-[calc(100vh-10rem)]">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              ...
              cosmic profiles. Enter your birth details and decode your destiny
              in 30 seconds.
            </p>
          ...
          {/* Right side - Four Pillars visualization */}
          <motion.div
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
            ...
            <div className="flex gap-4">
              {pillars.map((pillar, index) => (
                <motion.div
                  ...
                  className={`pillar-card rounded-2xl p-6 flex flex-col items-center gap-4 glow-${pillar.element}`}
                >
                  <span
                    className={`text-5xl sm:text-6xl font-serif ${pillar.color}`}
                  >
                    {pillar.chinese}
                  </span>
