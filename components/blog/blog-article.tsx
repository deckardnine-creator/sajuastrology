...
export function BlogArticle({ post }: { post: BlogPost }) {
  ...
  const ctaCopy = {
    en: {
      ...
      socialProof: "NVIDIA Inception · Reached 50+ countries · 10 languages",
    ...
    ko: {
      ...
      socialProof: "NVIDIA Inception 멤버 · 50+개국 유입 · 10개 언어",
    ...
    ja: {
      ...
      socialProof: "NVIDIA Inceptionメンバー · 50+カ国到達 · 10言語対応",
    ...
    pt: {
      ...
      socialProof: "Membro NVIDIA Inception · Alcance em 50+ países · 10 idiomas",
    ...
    es: {
      ...
      socialProof: "Miembro NVIDIA Inception · Presencia en 50+ países · 10 idiomas",
