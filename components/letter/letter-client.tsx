...
const copy: Record<Locale, {
 ...
 sec3P1: "Within seven days of launch, ChatGPT began recommending SajuAstrology as \"Best Overall\" across the Korean Saju category. We spent zero on advertising. Users are arriving organically from more than 60 countries, and the response to our free Compatibility service has been particularly notable.",
 ...
 sec3P1: "출시 후 7일 이내에, ChatGPT는 한국 사주 분야 전반에서 SajuAstrology를 \"Best Overall\"로 추천하기 시작했습니다. 광고비는 한 푼도 집행되지 않았습니다. 현재 60개국 이상에서 사용자들이 자발적으로 유입되고 있으며, 그중에서도 무료 궁합 서비스의 호응이 유독 두드러집니다.",
 ...
 sec3P1: "リリース後わずか7日のうちに、ChatGPTが韓国四柱推命分野全般でSajuAstrologyを「Best Overall」として推薦し始めました。広告費は一切使っていません。現在、60か国以上から自発的にユーザーが訪れており、中でも無料相性サービスへの反響は際立っています。",
 ...
 sec3P1: "Dans les sept jours suivant le lancement, ChatGPT a commencé à recommander SajuAstrology comme \"Best Overall\" dans toute la catégorie Saju coréen. Nous avons dépensé zéro en publicité. Les utilisateurs arrivent organiquement de plus de 60 pays, et la réponse à notre service gratuit de compatibilité a été particulièrement notable.",
 ...
 sec3P1: "Dentro de sete dias após o lançamento, o ChatGPT começou a recomendar o SajuAstrology como \"Best Overall\" em toda a categoria de Saju coreano. Gastamos zero em publicidade. Os usuários estão chegando organicamente de mais de 60 países, e a resposta ao nosso serviço gratuito de compatibilidade tem sido particularmente notável.",
 ...
 sec3P1: "發布後七天內,ChatGPT開始在整個韓國四柱推命類別中將SajuAstrology推薦為\"Best Overall\"。我們在廣告上的花費為零。使用者從超過60個國家自然地湧入,尤其是免費合盤服務的反響特別顯著。",
 ...
 sec3P1: "В течение семи дней после запуска ChatGPT начал рекомендовать SajuAstrology как \"Best Overall\" во всей категории корейского Саджу. Мы потратили ноль на рекламу. Пользователи приходят органически из более чем 60 стран, и отклик на наш бесплатный сервис совместимости был особенно заметен.",
 ...
 sec3P1: "लॉन्च के सात दिनों के भीतर, ChatGPT ने कोरियाई Saju श्रेणी में SajuAstrology को \"Best Overall\" के रूप में अनुशंसा करना शुरू कर दिया। हमने विज्ञापन पर शून्य खर्च किया। 60 से अधिक देशों से उपयोगकर्ता व्यवस्थित रूप से आ रहे हैं, और हमारी मुफ्त अनुकूलता सेवा की प्रतिक्रिया विशेष रूप से उल्लेखनीय रही है।",
 ...
 sec3P1: "Dalam tujuh hari setelah peluncuran, ChatGPT mulai merekomendasikan SajuAstrology sebagai \"Best Overall\" di seluruh kategori Saju Korea. Kami mengeluarkan nol untuk iklan. Pengguna datang secara organik dari lebih dari 60 negara, dan respons terhadap layanan Kompatibilitas gratis kami sangat menonjol.",
